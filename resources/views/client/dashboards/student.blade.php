  ...
  <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content vd-complaint-modal">
      ...
      <div class="modal-body">
        ...
        {{-- COMPLAINT FORM --}}
        <form id="complaintForm" class="vd-form" action="{{ route('student.complaints.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
...
<div class="dashboard-container">
    ...
    <header class="client-header text-center mb-4">
        ...
        <p>You're now connected to E-PACD Chat Support (Student)</p>
    </header>
        ...
        <div class="collapse mt-2" id="mobileFaq">
            <div class="faq-sidebar">
                <ul class="faq-list">
                    ...
                    <li data-question="Where can I get a copy of my transcript of grades?">Where can I get a copy of my transcript of grades?</li>
                    <li data-question="Where is the registrar's office?">Where is the registrar's office?</li>
                    <li data-question="How to request TOR?">How to request TOR?</li>
                    ...
                    <li data-question="How do I apply for shifting to another course?">How do I apply for shifting to another course?</li>
                    <li data-question="How do I request documents like certification, grades, or evaluation?">How do I request documents like certification, grades, or evaluation?</li>
                    <li data-question="How long does it take to process documents?">How long does it take to process documents?</li>
                    <li data-question="How do I withdraw my enrollment?">How do I withdraw my enrollment?</li>
                    <li data-question="Can students avail of free medical consultation at QSU?">Can students avail of free medical consultation at QSU?</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div id="chat-messages" class="chat-messages"></div>
        ...
        <div class="faq-sidebar d-none d-lg-block" id="faq-list-desktop">
            <h5>Need Help?</h5>
            <div class="px-3 pb-2 text-muted" style="font-size:13px;">
  Click a question to send it instantly.
</div>
            <ul class="faq-list">
                <li data-question="What are your office hours?">What are your office hours?</li>
                <li data-question="Where can I get a copy of my transcript of grades?">Where can I get a copy of my transcript of grades?</li>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  markReadBtn?.addEventListener('click', async (e) => {
    ...
    await fetch("{{ route('student.notifications.markRead') }}", {
      method: "POST",
      headers: {
  ...
  deleteReadBtn?.addEventListener('click', async (e) => {
    ...
    await fetch("{{ route('student.notifications.deleteRead') }}", {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        "X-CSRF-TOKEN": "{{ csrf_token() }}",
