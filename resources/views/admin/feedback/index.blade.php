    ...
    <div class="side-content">
        ...
        <div class="side-menu">
            <ul>
                ...
                <li><a href="{{ route('admin.feedback.index') }}" class="active" aria-current="page"><span class="fa-solid fa-comments"></span><small>Feedback</small></a></li>
                <li>
...
<div class="main-content">
    ...
    <div class="page-top">
        ...
        <div class="page-tools">
            ...
            @endphp
            <form method="GET" action="{{ route('admin.feedback.export.excel') }}" class="export-tools">
