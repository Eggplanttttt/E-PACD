...
<head>
    ...
    <title>QSU E-PACD | Student Password Forgot</title>
...
<div class="forgot-wrapper">
    <div class="forgot-card">
        ...
        <a href="{{ route('client.login', ['clientType' => 'student']) }}" class="back-btn">
        ...
        @if(session('reset_otp_sent'))
            ...
            <form method="POST" action="{{ route('student.password.otp.verify') }}">
                @csrf
        ...
        @else
            ...
            <form method="POST" action="{{ route('student.password.verify') }}" id="verify-email-form">
                @csrf
