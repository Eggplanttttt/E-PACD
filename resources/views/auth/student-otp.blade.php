...
<head>
    ...
    <title>QSU E-PACD | Student Email OTP</title>
...
<div class="forgot-wrapper">
    <div class="forgot-card">
        ...
        <a href="{{ route('student.password.forgot') }}" class="back-btn">
            ← Change email
        </a>
        ...
        <form method="POST" action="{{ route('student.password.otp.verify') }}" id="verify-otp-form">
            @csrf
