...
<head>
    ...
    <title>QSU E-PACD | Alumni Password Forgot</title>
...
<div class="forgot-wrapper">
    <div class="forgot-card">
        ...
        <a href="{{ route('client.login', ['clientType' => 'alumni']) }}" class="back-btn">
        ...
        @if(session('reset_otp_sent'))
            ...
            <form method="POST" action="{{ route('alumni.password.otp.verify') }}">
                @csrf
        ...
        @else
            ...
            <form method="POST" action="{{ route('alumni.password.verify') }}" id="verify-email-form">
                @csrf
