...
<head>
    ...
    <title>QSU E-PACD | Faculty Email OTP</title>
...
<div class="forgot-wrapper">
    <div class="forgot-card">
        ...
        <a href="{{ route('faculty.password.forgot') }}" class="back-btn">
            ← Change email
        </a>
        ...
        <form method="POST" action="{{ route('faculty.password.otp.verify') }}" id="verify-otp-form">
            @csrf
