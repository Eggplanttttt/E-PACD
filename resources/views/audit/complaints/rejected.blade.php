...
<main>
  <div class="vd-page">
    ...
    <div class="vd-top">
      <div>
        <div class="vd-breadcrumb">Audit / Complaints / Spams</div>
...
$(document).ready(function() {
  const table = $('#table-reject').DataTable({
    pageLength: 10,
    lengthChange: false,
    dom: 'rtip',
    order: [[3, 'asc']], // Date column (index 3) oldest -> latest
    columnDefs: [
      { targets: 0, orderable: false, searchable: false }, // ID not sortable/searchable
      { targets: 4, orderable: false } // Details not sortable
    ]
  });
