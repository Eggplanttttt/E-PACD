...
@section('title', 'IO Inquiries')

@push('styles')
<link rel="stylesheet" href="{{ asset('css/io-inquiries.css') }}">
@endpush
    ...
    <div class="side-content">
        <div class="profile">
            ...
            <ul>
                ...
                <li>
                    <a href="{{ route('io.inquiries.index') }}" class="active" aria-current="page">
                        <span class="fa-solid fa-question-circle"></span><small>Inquiries</small>
                    </a>
                </li>
                <li>
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // IO BASE URL (change endpoints to /io/inquiries/....)
    const BASE_URL = '/io/inquiries';
        ...
        try {
            ...
            if (data.success && Array.isArray(data.messages)) {
                data.messages.forEach(msg => {
                    if (!displayedMessageIds.has(msg.id)) appendMessage(msg);
                });
            }
        } catch (err) {
    ...
    function performSearch() {
        ...
        const messages = chatMessages.querySelectorAll('.p-2');
    ...
    searchInput.addEventListener('input', () => {
        ...
        performSearch();
        if (!searchActive) counter.textContent = "0";
    });
});
