...
class AlumniPasswordController extends Controller
{
    /**
    ...
    public function verifyEmail(Request $request)
    {
        ...
        Mail::to($request->email)->send(new PasswordResetOtp($otp));
         ...
         return redirect()->route('alumni.password.otp.form')
    ...
    public function verifyOtp(Request $request)
    {
        ...
        if (!$otp) {
            return redirect()->route('alumni.password.forgot')
        ...
        return redirect()->route('alumni.password.reset.form')
    ...
    public function resetPassword(Request $request)
    {
        ...
        if (!$alumni) {
            return redirect()->route('alumni.password.forgot')
                ->withErrors(['email' => 'Alumni not found.']);
        }
        ...
        return redirect()->route('client.login', ['clientType' => 'alumni'])
    ...
    public function showOtpForm()
    {
        ...
        return view('auth.alumni-otp'); // Blade for OTP input
    }
    ...
    public function showResetForm()
    {
        ...
        return view('auth.alumni-reset-password'); // Blade for new password
    }
