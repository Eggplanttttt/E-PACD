...
class StudentPasswordController extends Controller
{
    ...
    public function verifyEmail(Request $request)
    {
        ...
        Mail::to($request->email)->send(new PasswordResetOtp($otp));
         ...
         return redirect()->route('student.password.otp.form')
    ...
    public function resetPassword(Request $request)
    {
        ...
        if (!$student) {
            return redirect()->route('student.password.forgot')
                ->withErrors(['email' => 'Student not found.']);
        }
        ...
        return redirect()->route('client.login', ['clientType' => 'student'])
    ...
    public function showOtpForm()
    {
        ...
        return view('auth.student-otp'); // Blade for OTP input
    }
    ...
    public function showResetForm()
    {
        ...
        return view('auth.student-reset-password'); // Blade for new password
    }
