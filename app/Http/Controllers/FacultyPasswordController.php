...
class FacultyPasswordController extends Controller
{
    ...
    public function verifyEmail(Request $request)
    {
        ...
        if (!str_ends_with($request->email, '@libris.qsu.edu.ph')) {
            return back()->withErrors(['email' => 'Invalid Libris email.']);
        }
        ...
        Mail::to($request->email)->send(new PasswordResetOtp($otp));
         ...
         return redirect()->route('faculty.password.otp.form')
    ...
    public function verifyOtp(Request $request)
    {
        ...
        if (!$otp) {
            return redirect()->route('faculty.password.forgot')
        ...
        return redirect()->route('faculty.password.reset.form')
    ...
    public function resetPassword(Request $request)
    {
        ...
        if (!$faculty) {
            return redirect()->route('faculty.password.forgot')
                ->withErrors(['email' => 'Faculty not found.']);
        }
        ...
        return redirect()->route('client.login', ['clientType' => 'faculty'])
    ...
    public function showOtpForm()
    {
        ...
        return view('auth.faculty-otp'); // Blade for OTP input
    }
    ...
    public function showResetForm()
    {
        ...
        return view('auth.faculty-reset-password'); // Blade for new password
    }
